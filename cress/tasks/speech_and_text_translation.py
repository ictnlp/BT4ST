...
@register_task("speech_and_text_translation")
class SpeechAndTextTranslationTask(LegacyFairseqTask):
    @classmethod
    ...
    def build_model(self, args):
        ...
        model = super(SpeechAndTextTranslationTask, self).build_model(args)
